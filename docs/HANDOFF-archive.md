...
- **Board polish (Farah: "images look messy, header clunky").**
  - **Portrait 3:4 thumbnails** (was square) for grid + hero — lookbook framing, uniform crop tidies a wall of mixed-shop photos. Inline list thumbs (sized) stay square. ⚠️ **Consistency flag:** Library art is still square (album/film art suits square) — Things now diverges deliberately as content-appropriate; revisit if you want Library portrait too.
