      ...
      <div style={{ position: 'relative', margin: '-20px -18px 0', flexShrink: 0 }}>
        {hero
          ? <img src={hero} onError={imgFallback(p.image)} alt="" loading="lazy"
              style={{ display: 'block', width: '100%', aspectRatio: '4 / 5', maxHeight: 'min(470px, 51dvh)', objectFit: showCutout ? 'contain' : 'cover',
          ...
          : <div style={{ width: '100%', aspectRatio: '4 / 5', maxHeight: 'min(470px, 51dvh)', background: TILE, borderRadius: '20px 20px 0 0', display: 'flex', alignItems: 'center', justifyContent: 'center', color: MUTED, fontSize: 12 }}>no image</div>}
