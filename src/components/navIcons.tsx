...
export function LibraryIcon({ size = 24 }: { size?: number }) {
  return (
...
// Things taste tab.
export function TasteIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
...
export function DiscoverIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
...
export function WishlistIcon({ size = 24 }: { size?: number }) {
  return (
